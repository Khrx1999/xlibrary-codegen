...
import type { RecorderLang, RobotCodegenOptions } from '../src/types.js';
...
// ---------------------------------------------------------------------------
// RecorderLang type — all valid values compile and are covered
// ---------------------------------------------------------------------------

describe('RecorderLang — type coverage', () => {
  const ALL_LANGS: RecorderLang[] = ['robot', 'selenium', 'ts', 'python'];
  ...
  it('ts/python/selenium IDs are identical regardless of directMode', () => {
    ...
    for (const lang of ['ts', 'python', 'selenium'] as RecorderLang[]) {
...
describe('RobotCodegenOptions — lang field', () => {
  ...
  it('lang accepts all valid RecorderLang values', () => {
